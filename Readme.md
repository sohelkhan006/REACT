...
This repository contains multiple small React applications built for learning, practice, and experimentation with React concepts.
...
- HTML5
- CSS3
- React Router (for routing project)
- NPM
...
- Improve component-based architecture understanding
- Learn routing, state management, and UI building
- Experiment with small React projects
